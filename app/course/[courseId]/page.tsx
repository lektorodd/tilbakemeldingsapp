  ...
  return (
    <main className="min-h-screen bg-background py-8 px-4">
      <div className="max-w-7xl mx-auto">
        ...
        {/* Students section - Full width with grid layout */}
                ...
                >
                  <div className="flex items-start justify-between mb-2">
                    <div className="flex-1 min-w-0">
                      <h4 className="font-medium text-text-primary truncate" title={student.name}>{student.name}</h4>
                      {student.studentNumber && (
                        <p className="text-xs text-text-disabled truncate">#{student.studentNumber}</p>
                      )}
                    </div>
                    <button
                      onClick={() => handleDeleteStudent(student.id)}
                      className="p-1 text-danger hover:bg-red-50 rounded transition flex-shrink-0"
        ...
        {/* Tests and Oral Assessments side by side */}
